      ...
      >
        ...
        {featuredImageUrl && (
          <div className="relative w-full aspect-video bg-muted overflow-hidden">
            ...
            {/* Trending Badge */}
            <div className="absolute top-2 right-2 bg-yellow-400/90 backdrop-blur-sm text-slate-900 px-2 py-1 rounded text-xs font-bold flex items-center gap-1 z-10">
